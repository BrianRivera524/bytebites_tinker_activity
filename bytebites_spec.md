...
1. Customer
   ...
   - Represents a ByteBites user.
   - Stores the customer's name and past purchase history.

2. FoodItem

   - Represents an individual item sold by ByteBites.
   - Stores the item's name, price, category, and popularity rating.

3. Menu

   - Represents the full collection of food items.
   - Stores all available food items and allows filtering by category.

4. Transaction

   - Represents a customer's order.
   - Stores the selected food items and calculates the total cost.
